...
public interface MapperBoard {
    ...
    @Mapping(source = "ownerId", target = "owner", qualifiedByName = "stringToObjectId")
    @Mapping(source = "administratorIds", target = "administrators", qualifiedByName = "stringListToObjectIdList")
    @Mapping(source = "editorIds", target = "editors", qualifiedByName = "stringListToObjectIdList")
    @Mapping(source = "viewerIds", target = "viewers", qualifiedByName = "stringListToObjectIdList")
    @Mapping(source = "status", target = "status", qualifiedByName = "stringToProjectStatus")
    @Mapping(source = "phaseIds", target = "columns", qualifiedByName = "stringListToObjectIdList")
    ...
    @Mapping(source = "owner", target = "ownerId", qualifiedByName = "objectIdToString")
    @Mapping(source = "administrators", target = "administratorIds", qualifiedByName = "objectIdListToStringList")
    @Mapping(source = "editors", target = "editorIds", qualifiedByName = "objectIdListToStringList")
    @Mapping(source = "viewers", target = "viewerIds", qualifiedByName = "objectIdListToStringList")
    @Mapping(source = "status", target = "status", qualifiedByName = "projectStatusToString")
    @Mapping(source = "columns", target = "phaseIds", qualifiedByName = "objectIdListToStringList")
